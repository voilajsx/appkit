          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              {showSidebar && (
                <button
                  ...
                  className="p-1.5 text-gray-500 rounded-md lg:hidden hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            ...
            <div className="flex items-center space-x-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hidden md:flex items-center p-1.5 text-gray-500 rounded-md bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
